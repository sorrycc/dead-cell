...
export const ROOM_TYPES_BY_ID = Object.fromEntries(ROOM_TYPES.map((e) => [e.type.id, e.type]))

// The ordered list (for the verifier sweep + any list rendering).
export const ROOM_TYPE_ORDER = ROOM_TYPES.map((e) => e.type)
